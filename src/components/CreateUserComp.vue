        ...
        <div class="container">
            <div class="row justify-content-md-center">
                <div class="col-12 col-sm-12 col-md-6">
                    ...
                    <div class="col">
                        <button class="btn btn-outline-light" @click="createUserEvent">
                            Create User
                        </button>
                    </div>
            ...
            try {
                ...
                if ("response" in error)
                    if ("data" in error.response) {
                        if (error.response.data.errorCode === "UsernameExistsException")
                            alert(error.response.data.errorMessage);
                        else if (error.response.data.errorCode === "NotAuthorizedException")
                            alert(error.response.data.errorMessage);
                        else if (
                            ...
                            error.response.data.errorCode === "InvalidParameterException"
                        )
                            alert(error.response.data.errorMessage);
                        else if (error.response.data.errorCode === "InternalErrorException")
                            alert(error.response.data.errorMessage);
